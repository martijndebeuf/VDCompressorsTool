...
export default {
  ...
  data(){
    return {
      items: [
        { title: 'Dashboard', icon: 'mdi-home', link: '/client/dashboard' },
        { title: 'Favorieten', icon: 'mdi-star', link: '/client/favourites' },
        { title: 'Onderhoud', icon: 'mdi-calendar', link: '/client/calendar'},
        { divider: true },
        { heading: 'HELP' },
